...
CREATE TABLE system_alerts (
    ...
    acknowledged_by UUID, -- REFERENCES users(id) - commented out as users table may not exist yet
...
CREATE TABLE service_dependencies (
    ...
    degradation_behavior VARCHAR(100),
...
CREATE TABLE system_status_snapshots (
    ...
    metric_summaries JSONB NOT NULL,
    created_at TIMESTAMPTZ DEFAULT CURRENT_TIMESTAMP
);
