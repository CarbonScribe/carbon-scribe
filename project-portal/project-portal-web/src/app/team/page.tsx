        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between">
          <div>
            ...
            <p className="text-emerald-100 opacity-90">
              Manage your project team and community engagement
            </p>
          </div>
            ...
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-6">
              <div>
                ...
                <p className="text-gray-600">
                  Manage your project team and collaborators
                </p>
              </div>
                    ...
                    >
                      ...
                      <div className="flex items-start justify-between mb-4">
                        <div className="flex items-center">
                          <div
                            className={`${member.avatarColor} w-12 h-12 rounded-full flex items-center justify-center text-white font-bold text-lg mr-4`}
                          >
                            {member.name
                              .split(" ")
                              .map((n) => n[0])
      ...
      <div className="bg-white rounded-2xl p-6 shadow-lg border border-gray-100">
        <div className="flex items-center justify-between mb-6">
          <div>
            ...
            <p className="text-gray-600">
              Track team training and certification status
            </p>
          </div>
              ...
              {[
                {
                  name: "Samuel Kariuki",
                  role: "Lead Farmer",
                  training: "Carbon Farming Basics",
                  progress: 100,
                  certified: true,
                },
                {
                ...
                },
                {
                  name: "Raj Patel",
                  role: "Soil Scientist",
                  training: "Advanced Soil Analysis",
                  progress: 60,
                  certified: false,
                },
                {
                  name: "Fatima Al-Mansoori",
                  role: "Mangrove Specialist",
                  training: "Blue Carbon Methodologies",
                  progress: 100,
                  certified: true,
                },
                {
