        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between">
          <div>
            ...
            <p className="text-emerald-100 opacity-90">
              Manage carbon credit sales, revenue, and financing options
            </p>
          </div>
            ...
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-6">
              <div>
                ...
                <p className="text-gray-600">
                  Track your credit issuance and sales
                </p>
              </div>
                        ...
                        >
                          <td className="py-4 px-4">
                            ...
                            <div className="text-sm text-gray-600">
                              {credit.methodology} • {credit.verification}
                            </div>
                          </td>
                          <td className="py-4 px-4">
                            <div className="font-medium text-gray-900">
                ...
                return (
                  ...
                  >
                    <div className="flex items-start justify-between mb-3">
                      <div
                        className={`p-2 rounded-lg bg-linear-to-r ${option.color}`}
                      >
      ...
      <div className="bg-white rounded-2xl p-6 shadow-lg border border-gray-100">
        <div className="flex items-center justify-between mb-6">
          <div>
            ...
            <p className="text-gray-600">
              How your carbon credit revenue is allocated
            </p>
          </div>
        ...
        <div className="grid md:grid-cols-4 gap-6">
          {[
            ...
            <div key={index} className="text-center">
              <div
                className={`h-2 ${item.color} rounded-full mb-3`}
