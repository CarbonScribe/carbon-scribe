            ...
            <div className="flex items-center gap-3 mb-4">
              ...
              <div>
                ...
                <p className="text-cyan-100 mt-2">
                  Deep insights into your carbon projects' performance
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          <div className="bg-white rounded-2xl p-6 shadow-lg border border-gray-100">
            <div className="flex items-center justify-between mb-6">
              ...
              <div
                className={`px-3 py-1 rounded-full ${getMetricColor(selectedMetric)} bg-opacity-10 font-medium`}
              >
            ...
            <div className="h-64 flex items-end justify-between space-x-2 pt-8">
              {monthlyData.map((data, index) => {
                const value = data[
                  selectedMetric as keyof typeof data
                ] as number;
                      ...
                      className={`w-full rounded-t-lg transition-all duration-500 ${
                        selectedMetric === "carbon"
                          ...
                          : selectedMetric === "revenue"
                            ? "bg-linear-to-t from-amber-400 to-amber-500"
          ...
          <div className="bg-linear-to-br from-emerald-500 to-teal-600 rounded-2xl p-6 text-white">
            ...
            <div className="space-y-6">
              {[
                ...
                {
                  label: "Revenue per Credit",
                  value: "$12.40",
                  benchmark: "$10.80",
                  status: "above",
                },
                {
                  label: "Farmer Engagement",
                  value: "94%",
                  benchmark: "85%",
                  status: "above",
                },
