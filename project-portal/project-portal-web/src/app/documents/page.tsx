...
const DocumentsPage = () => {
  ...
  const categories = [
    ...
    },
    {
      id: "planning",
      name: "Planning",
      count: documents.filter((d) => d.category === "planning").length,
      icon: FileText,
      color: "bg-blue-500",
    },
    {
      id: "monitoring",
      name: "Monitoring",
      count: documents.filter((d) => d.category === "monitoring").length,
      icon: BarChart,
    ...
    },
    {
      id: "certification",
      name: "Certification",
      count: documents.filter((d) => d.category === "certification").length,
      icon: CheckCircle,
      color: "bg-purple-500",
    },
    {
    ...
    },
    {
      id: "finance",
      name: "Financial",
      count: documents.filter((d) => d.category === "finance").length,
      icon: FileType,
      color: "bg-green-500",
    },
    {
      id: "training",
      name: "Training",
      count: documents.filter((d) => d.category === "training").length,
      icon: FileText,
      color: "bg-cyan-500",
    },
  ];
        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between">
          <div>
            ...
            <p className="text-emerald-100 opacity-90">
              Central repository for all project documents and reports
            </p>
          </div>
          ...
          <div className="bg-white rounded-2xl p-6 shadow-lg border border-gray-100">
                ...
                return (
                  ...
                  >
                    <div className="flex items-center">
                      <div
                        className={`p-2 rounded-lg ${category.color} bg-opacity-10 mr-3`}
                      >
                        <Icon
            ...
            <div className="mt-8 pt-6 border-t border-gray-200">
              ...
              <div className="space-y-3">
                {[
                  {
                    action: 'Uploaded "Soil Analysis"',
                    user: "Raj Patel",
                    time: "2 hours ago",
                  },
                  {
                    action: 'Approved "Monitoring Report"',
                    user: "Samuel Kariuki",
                    time: "1 day ago",
                  },
                  {
                    action: 'Downloaded "Training Materials"',
                    user: "New Farmer",
                    time: "2 days ago",
                  },
                ].map((activity, index) => (
