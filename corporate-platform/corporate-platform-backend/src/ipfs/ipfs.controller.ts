...
export class IpfsController {
  ...
  async batchUpload(
    ...
    return this.upload.batchUpload(body.files || [], body.metadata || {});
  }
  ...
  async anchorCertificate(
    ...
    return this.certificate.anchorCertificate(retirementId, body || {});
  }
  ...
  @Get('documents')
  async listDocuments(@Query('companyId') companyId?: string) {
    return this.upload.listDocuments(companyId);
  }
