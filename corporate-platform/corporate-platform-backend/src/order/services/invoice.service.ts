    ...
    async generateInvoice(
        ...
        return new Promise<Buffer>((resolve, reject) => {
            ...
            doc
                ...
                .text('Qty', 250, doc.y - doc.currentLineHeight(), { width: 50, align: 'right' })
                .text('Unit Price', 310, doc.y - doc.currentLineHeight(), { width: 80, align: 'right' })
                .text('Total', 400, doc.y - doc.currentLineHeight(), { width: 100, align: 'right' })
                .moveDown(0.5);
            ...
            for (const item of order.items) {
                ...
                doc
                    ...
                    .text(item.quantity.toString(), 250, yPos, { width: 50, align: 'right' })
                    .text(`$${item.unitPrice.toFixed(2)}`, 310, yPos, { width: 80, align: 'right' })
                    .text(`$${item.totalPrice.toFixed(2)}`, 400, yPos, { width: 100, align: 'right' })
                    .moveDown(0.5);
            }
            ...
            doc
                ...
                .text(`Service Fee: $${order.serviceFee.toFixed(2)}`, { align: 'right' })
                .font('Helvetica-Bold')
