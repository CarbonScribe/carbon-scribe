    ...
    const mockOrders = [
        {
            ...
            statusEvents: [
                { id: 'evt-1', orderId: 'order-1', status: 'pending', message: null, createdAt: new Date('2024-03-15T09:00:00Z') },
                { id: 'evt-2', orderId: 'order-1', status: 'completed', message: 'Order completed', createdAt: new Date('2024-03-15T10:00:00Z') },
            ],
        },
    ];
